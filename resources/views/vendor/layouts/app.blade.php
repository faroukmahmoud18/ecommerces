...
<head>
    ...
    <title>@yield('title', 'لوحة تحكم البائع') - {{ config('app.name', 'متجر متعدد البائعين') }}</title>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav me-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{ request()->is('vendor/reports*') ? 'active' : '' }}" href="{{ route('vendor.reports.sales') }}">
                            <i class="fas fa-chart-bar me-1"></i> التقارير
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link {{ request()->is('vendor/payouts*') ? 'active' : '' }}" href="{{ route('vendor.payouts.index') }}">
                ...
                <ul class="navbar-nav">
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end">
                            ...
                            <li>
                                <a class="dropdown-item" href="{{ route('vendor.logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
