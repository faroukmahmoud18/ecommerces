                                    ...
                                    <div class="btn-group btn-group-sm">
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-end">
                                                <a class="dropdown-item {{ $order->status === 'pending' ? '' : 'disabled' }}" href="{{ route('admin.orders.update-status', $order->id) }}?status=confirmed">
                                                    <i class="fas fa-check-circle me-1"></i> تأكيد الطلب
                                                </a>
                                                <a class="dropdown-item {{ in_array($order->status, ['pending', 'confirmed']) ? '' : 'disabled' }}" href="{{ route('admin.orders.update-status', $order->id) }}?status=processing">
                                                    <i class="fas fa-cogs me-1"></i> معالجة الطلب
                                                </a>
                                                <a class="dropdown-item {{ in_array($order->status, ['pending', 'confirmed', 'processing']) ? '' : 'disabled' }}" href="{{ route('admin.orders.create-shipment', $order->id) }}">
                                                    <i class="fas fa-shipping-fast me-1"></i> شحن الطلب
                                                </a>
                                                <div class="dropdown-divider"></div>
                                                <a class="dropdown-item {{ $order->status === 'pending' ? '' : 'disabled' }}" href="{{ route('admin.orders.update-status', $order->id) }}?status=cancelled">
